    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">{currentOrg?.name} · Knowledge Base</p>
        </div>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-16 text-center">
        ...
        <p className="text-sm text-gray-500 mb-6 max-w-md mx-auto">
          Centralize white papers, case studies, brand guidelines, training materials, and research documents.
        </p>
        <button className="btn-primary">Add First Resource</button>
      </div>
    </div>
  )
}
