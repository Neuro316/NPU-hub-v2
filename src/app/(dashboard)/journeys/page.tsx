...
export default function JourneysPage() {
  ...
  const generateJourney = async () => {
    ...
    try {
      ...
      if (!content) {
        setAiError('AI returned empty response. Try again.')
        setAiLoading(false)
        return
      }
      ...
      setAiError('AI generation failed: ' + (err.message || 'Unknown error. Check that ANTHROPIC_API_KEY is set in Vercel environment variables.'))
    }
    setAiLoading(false)
  }
