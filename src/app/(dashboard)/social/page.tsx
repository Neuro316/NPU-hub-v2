...
const PL: Record<string, { name: string; icon: string; color: string; cl: number; formats: Array<{ id: string; name: string; w: number; h: number; r: string }> }> = {
  instagram: { name: 'Instagram', icon: 'ðŸ“¸', color: '#E1306C', cl: 2200, formats: [{ id: 'ig-sq', name: 'Square', w: 1080, h: 1080, r: '1:1' }, { id: 'ig-port', name: 'Portrait', w: 1080, h: 1350, r: '4:5' }, { id: 'ig-story', name: 'Story/Reel', w: 1080, h: 1920, r: '9:16' }, { id: 'ig-land', name: 'Landscape', w: 1080, h: 566, r: '1.91:1' }] },
  facebook: { name: 'Facebook', icon: 'ðŸ“˜', color: '#1877F2', cl: 63206, formats: [{ id: 'fb-sq', name: 'Square', w: 1080, h: 1080, r: '1:1' }, { id: 'fb-land', name: 'Landscape', w: 1200, h: 630, r: '1.91:1' }, { id: 'fb-story', name: 'Story', w: 1080, h: 1920, r: '9:16' }] },
  linkedin: { name: 'LinkedIn', icon: 'ðŸ’¼', color: '#0A66C2', cl: 3000, formats: [{ id: 'li-sq', name: 'Square', w: 1080, h: 1080, r: '1:1' }, { id: 'li-port', name: 'Portrait', w: 1080, h: 1350, r: '4:5' }, { id: 'li-land', name: 'Landscape', w: 1200, h: 627, r: '1.91:1' }, { id: 'li-art', name: 'Article', w: 1280, h: 720, r: '16:9' }] },
  tiktok: { name: 'TikTok', icon: 'ðŸŽµ', color: '#010101', cl: 2200, formats: [{ id: 'tt-vid', name: 'Video', w: 1080, h: 1920, r: '9:16' }] },
  x: { name: 'X (Twitter)', icon: 'ð•', color: '#1DA1F2', cl: 280, formats: [{ id: 'tw-img', name: 'Image', w: 1600, h: 900, r: '16:9' }, { id: 'tw-sq', name: 'Square', w: 1080, h: 1080, r: '1:1' }] },
  youtube: { name: 'YouTube', icon: 'ðŸ“º', color: '#FF0000', cl: 5000, formats: [{ id: 'yt-thumb', name: 'Thumbnail', w: 1280, h: 720, r: '16:9' }, { id: 'yt-short', name: 'Short', w: 1080, h: 1920, r: '9:16' }] },
}

const CONTENT_TYPES = [
  { id: 'edu', name: 'Educational', icon: 'ðŸ§ ' },
  { id: 'story', name: 'Story', icon: 'ðŸ“–' },
  { id: 'promo', name: 'Promotional', icon: 'ðŸ“£' },
  { id: 'engage', name: 'Engagement', icon: 'ðŸ’¬' },
  { id: 'authority', name: 'Authority', icon: 'ðŸ†' },
  { id: 'bts', name: 'Behind Scenes', icon: 'ðŸŽ¬' },
]
  ...
  return (
    <div className="h-[calc(100vh-72px)] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-3">
        <div>
          <h1 className="text-xl font-semibold text-np-dark flex items-center gap-2">ðŸŽ¨ Social Media Designer</h1>
        ...
        <div className="flex gap-1.5">
          {([['create', 'âœ¨ Create'], ['posts', `ðŸ“‹ Posts (${posts.length})`], ['voices', `ðŸŽ­ Voices (${voices.length})`]] as const).map(([k, l]) => (
      ...
      {/* â•â•â• CREATE TAB: 3-PANEL LAYOUT â•â•â• */}
      {tab === 'create' && (
              ...
              {msgs.map((m, i) => (
                <div key={i} className={`flex ${m.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[88%] px-3.5 py-2.5 rounded-xl text-sm leading-relaxed whitespace-pre-wrap ${m.role === 'user' ? 'bg-np-blue text-white rounded-br-sm' : 'bg-gray-50 text-np-dark border border-gray-100 rounded-bl-sm'}`}>
                    {m.role === 'ai' && <div className="text-[8px] font-bold text-purple-500 uppercase tracking-wider mb-1">ðŸŸ£ CMO AI</div>}
                    {m.content}
                    {m.role === 'ai' && i > 0 && (
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        {post.scheduled_at && <span className="text-[8px] text-blue-500">ðŸ“… {new Date(post.scheduled_at).toLocaleString('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' })}</span>}
                      </div>
      ...
      {/* â•â•â• VOICES TAB â•â•â• */}
      {tab === 'voices' && (
        <div className="flex-1 overflow-y-auto max-w-3xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-base font-bold text-np-dark">ðŸŽ­ Advisory Voices</h2>
              ...
              <div key={v.id} className="bg-white border border-gray-100 rounded-xl p-3.5"
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex gap-1">
                    <button onClick={() => openVoiceEditor(v)} className="text-[10px] text-gray-400 hover:text-np-blue">âœï¸</button>
